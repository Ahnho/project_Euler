...
/* Command for C compiler:
   g++ -c  -w -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -mcet -fcf-protection -w -fpermissive  -I/usr/share/nim -o /home/sangho/Documents/Euiler/NIM/nim.Euler/nimcache/stdlib_macros.o /home/sangho/Documents/Euiler/NIM/nim.Euler/nimcache/stdlib_macros.cpp */
...
N_LIB_PRIVATE N_NIMCALL(NimStringDesc*, dollar__Yy6vNPknrxyp1xFe9a5mM3g)(tyObject_LineInfo_iaJhdGB5Q2GppYhH0fz7tg arg) {
	...
	T1_ = rawNewString(arg.filename->len + T2_->len + T3_->len + 4);
...
{		result = ((NI) 1);
	...
	LA3_: ;
	{
		...
		while (1) {
			...
			NIM_CHAR aa = toLower_Fwx7k03EYImpkyEMwVKBpAmacros(a[i]);
			nimln_(1146, "macros.nim");
			NIM_CHAR bb = toLower_Fwx7k03EYImpkyEMwVKBpAmacros(b[j]);
