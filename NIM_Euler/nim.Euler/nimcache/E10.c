...
/* Command for C compiler:
   gcc -c  -w -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection  -I/usr/share/nim -o /home/sangho/Documents/Euler/NIM_Euler/nim.Euler/nimcache/E10.o /home/sangho/Documents/Euler/NIM_Euler/nim.Euler/nimcache/E10.c */
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, is_primes_JYzAKAdquOIpQIJnyXy4bQ)(NI x);
...
N_LIB_PRIVATE N_NIMCALL(NI64, primes2_mbB8372gDcBTw9cHY4AflKg)(void);
static N_NIMCALL(void, Marker_tySequence_IHUFRsFxZNv7YydiUO2esQ)(void* p, NI op);
N_NIMCALL(void*, newSeq)(TNimType* typ, NI len);
N_NIMCALL(TGenericSeq*, incrSeqV2)(TGenericSeq* seq, NI elemSize);
N_LIB_PRIVATE N_NIMCALL(NI64, sum_iXMZqN9bUdF18OSYDw4GyCA)(NI64* x, NI xLen_0);
...
NIM_EXTERNC N_NOINLINE(void, E10DatInit000)(void);
...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, is_primes_JYzAKAdquOIpQIJnyXy4bQ)(NI x) {
	NIM_BOOL result;
	nimfr_("is_primes", "E10.nim");
{	result = (NIM_BOOL)0;
	{
		NI i;
		NI colontmp_;
		NI TM_UFzmemY2nYbcQ9aibIUn29cA_2;
		NI res;
		i = (NI)0;
		colontmp_ = (NI)0;
		nimln_(4, "E10.nim");
		TM_UFzmemY2nYbcQ9aibIUn29cA_2 = divInt(x, ((NI) 2));
		colontmp_ = (NI)(TM_UFzmemY2nYbcQ9aibIUn29cA_2);
		nimln_(2045, "system.nim");
		res = ((NI) 2);
		{
			nimln_(2046, "system.nim");
			while (1) {
				NI TM_UFzmemY2nYbcQ9aibIUn29cA_4;
				if (!(res <= colontmp_)) goto LA3;
				nimln_(2047, "system.nim");
				i = res;
				nimln_(5, "E10.nim");
				{
					NI TM_UFzmemY2nYbcQ9aibIUn29cA_3;
					TM_UFzmemY2nYbcQ9aibIUn29cA_3 = modInt(x, i);
					if (!((NI)(TM_UFzmemY2nYbcQ9aibIUn29cA_3) == ((NI) 0))) goto LA6_;
					nimln_(6, "E10.nim");
					result = NIM_FALSE;
					goto BeforeRet_;
				}
				...
				TM_UFzmemY2nYbcQ9aibIUn29cA_4 = addInt(res, ((NI) 1));
				res = (NI)(TM_UFzmemY2nYbcQ9aibIUn29cA_4);
			} LA3: ;
		}
	}
	nimln_(7, "E10.nim");
...
N_LIB_PRIVATE N_NIMCALL(NI64, primes2_mbB8372gDcBTw9cHY4AflKg)(void) {
	NI64 result;
	tySequence_IHUFRsFxZNv7YydiUO2esQ* a;
	nimfr_("primes_2", "E10.nim");
{	result = (NI64)0;
	nimln_(10, "E10.nim");
	a = (tySequence_IHUFRsFxZNv7YydiUO2esQ*) newSeq((&NTI_IHUFRsFxZNv7YydiUO2esQ_), 0);
	{
		NI i;
		NI res;
		i = (NI)0;
		...
		res = ((NI) 2);
		{
			nimln_(2046, "system.nim");
			while (1) {
				NI TM_UFzmemY2nYbcQ9aibIUn29cA_5;
				if (!(res <= ((NI) 2000000))) goto LA3;
				nimln_(2047, "system.nim");
				i = res;
				nimln_(12, "E10.nim");
				{
					...
					NI T9_;
					T6_ = (NIM_BOOL)0;
					T6_ = is_primes_JYzAKAdquOIpQIJnyXy4bQ(i);
					if (!T6_) goto LA7_;
					nimln_(13, "E10.nim");
					a = (tySequence_IHUFRsFxZNv7YydiUO2esQ*) incrSeqV2(&(a)->Sup, sizeof(NI64));
					T9_ = a->Sup.len++;
					a->data[T9_] = ((NI64) (i));
				}
				LA7_: ;
				nimln_(2048, "system.nim");
				TM_UFzmemY2nYbcQ9aibIUn29cA_5 = addInt(res, ((NI) 1));
				res = (NI)(TM_UFzmemY2nYbcQ9aibIUn29cA_5);
			} LA3: ;
		}
	}
	nimln_(14, "E10.nim");
	result = sum_iXMZqN9bUdF18OSYDw4GyCA(a->data, a->Sup.len);
	goto BeforeRet_;
	}BeforeRet_: ;
	popFrame();
	return result;
...
NIM_EXTERNC N_NOINLINE(void, NimMainModule)(void) {
	...
	T2_ = (NI64)0;
	T2_ = primes2_mbB8372gDcBTw9cHY4AflKg();
