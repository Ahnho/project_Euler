...
/* Command for C compiler:
   gcc -c  -w -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection  -I/usr/share/nim -o /home/sangho/Documents/Euler/NIM_Euler/nim.Euler/nimcache/E1.o /home/sangho/Documents/Euler/NIM_Euler/nim.Euler/nimcache/E1.c */
...
N_LIB_PRIVATE N_NIMCALL(NI, sum35_Fwp6DQR09clCk7vuFFRH9bHQ)(void);
	...
	a = ((NI) 0);
	{
		...
		res = ((NI) 1);
		{
			...
			while (1) {
				...
				{
					NIM_BOOL T6_;
					NI TM_k3rWAHgMLQPHWpejpW26fg_2;
					NI TM_k3rWAHgMLQPHWpejpW26fg_3;
					NI TM_k3rWAHgMLQPHWpejpW26fg_4;
					T6_ = (NIM_BOOL)0;
					TM_k3rWAHgMLQPHWpejpW26fg_2 = modInt(i, ((NI) 3));
					T6_ = ((NI)(TM_k3rWAHgMLQPHWpejpW26fg_2) == ((NI) 0));
					if (T6_) goto LA7_;
					TM_k3rWAHgMLQPHWpejpW26fg_3 = modInt(i, ((NI) 5));
					T6_ = ((NI)(TM_k3rWAHgMLQPHWpejpW26fg_3) == ((NI) 0));
					LA7_: ;
					if (!T6_) goto LA8_;
					nimln_(7, "E1.nim");
					TM_k3rWAHgMLQPHWpejpW26fg_4 = addInt(a, i);
					a = (NI)(TM_k3rWAHgMLQPHWpejpW26fg_4);
				}
				LA8_: ;
				nimln_(2048, "system.nim");
				TM_k3rWAHgMLQPHWpejpW26fg_5 = addInt(res, ((NI) 1));
				res = (NI)(TM_k3rWAHgMLQPHWpejpW26fg_5);
			} LA3: ;
		}
	}
	nimln_(8, "E1.nim");
...
NIM_EXTERNC N_NOINLINE(void, NimMainModule)(void) {
	...
	T2_ = (NI)0;
	T2_ = sum35_Fwp6DQR09clCk7vuFFRH9bHQ();
